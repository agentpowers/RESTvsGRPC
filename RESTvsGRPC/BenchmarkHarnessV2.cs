...
namespace RESTvsGRPC
{
    ...
    [CsvExporter]
    [HtmlExporter]
    public class BenchmarkHarnessV2
    {
        [Params(10)]
        public int IterationCount;

        readonly RESTClient restClient = new RESTClient();
        readonly GRPCClientV2 grpcClient = new GRPCClientV2();
    ...
    public class AllowNonOptimizedV2 : ManualConfig
    {
        public AllowNonOptimizedV2()
        {
